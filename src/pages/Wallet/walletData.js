...
export const contacts = [
  { name: 'Anika Sharma', handle: '@anika.kt', payId: 'anika@ktpay', recent: true },
  { name: 'Rohit Verma', handle: '@rohitv', payId: 'rohit@ktpay', recent: true },
  { name: 'Meera Nair', handle: '@meera.n', payId: 'meera@ktpay', recent: true },
  { name: 'Arjun Patel', handle: '@arjunp', payId: 'arjun@ktpay', recent: true },
  { name: 'Sana Qureshi', handle: '@sanaq', payId: 'sana@ktpay', recent: false },
  { name: 'Dev Malhotra', handle: '@devm', payId: 'dev@ktpay', recent: false },
  { name: 'Ishita Roy', handle: '@ishitar', payId: 'ishita@ktpay', recent: false },
  { name: 'Kabir Singh', handle: '@kabirs', payId: 'kabir@ktpay', recent: false },
]

export const transactionCategories = ['All', 'Sent', 'Received', 'Shopping', 'Bills', 'Food', 'Travel']

export const initialTransactions = [
  { id: 't1', name: 'Anika Sharma', note: 'Dinner split', category: 'Sent', direction: 'out', amount: 500, date: 'Today, 2:45 PM', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't2', name: 'Orbit Mart', note: 'Failed order refund', category: 'Received', direction: 'in', amount: 1200, date: 'Today, 11:02 AM', method: 'KT Rapid Transfer', status: 'Completed' },
  { id: 't3', name: 'Roast House Coffee', note: 'Cold brew ×2', category: 'Food', direction: 'out', amount: 340, date: 'Today, 9:18 AM', method: 'Scan & pay', status: 'Completed' },
  { id: 't4', name: 'Rohit Verma', note: 'Trip fuel share', category: 'Received', direction: 'in', amount: 450, date: 'Yesterday, 8:30 PM', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't5', name: 'KT Store', note: 'Mechanical keyboard', category: 'Shopping', direction: 'out', amount: 1599, date: 'Yesterday, 6:12 PM', method: 'KT Card', status: 'Completed' },
  { id: 't6', name: 'Nova Broadband', note: 'August bill', category: 'Bills', direction: 'out', amount: 1099, date: 'Yesterday, 10:40 AM', method: 'Autopay', status: 'Completed' },
  ...
  { id: 't8', name: 'CityRide', note: 'Airport drop', category: 'Travel', direction: 'out', amount: 742, date: '05 Aug 2026', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't9', name: 'Meera Nair', note: 'Concert tickets', category: 'Sent', direction: 'out', amount: 2400, date: '04 Aug 2026', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't10', name: 'QuickBite', note: 'Weekend order', category: 'Food', direction: 'out', amount: 618, date: '04 Aug 2026', method: 'KT Card', status: 'Completed' },
  { id: 't11', name: 'Freelance invoice #218', note: 'Design retainer', category: 'Received', direction: 'in', amount: 42000, date: '03 Aug 2026', method: 'KT Batch Transfer', status: 'Completed' },
  { id: 't12', name: 'Metro Power', note: 'Electricity bill', category: 'Bills', direction: 'out', amount: 2340, date: '03 Aug 2026', method: 'Autopay', status: 'Completed' },
  { id: 't13', name: 'SkyLink Airlines', note: 'Return leg', category: 'Travel', direction: 'out', amount: 5480, date: '02 Aug 2026', method: 'KT Card', status: 'Completed' },
  { id: 't14', name: 'Arjun Patel', note: 'Gift pool', category: 'Sent', direction: 'out', amount: 1000, date: '02 Aug 2026', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't15', name: 'FreshCart', note: 'Weekly groceries', category: 'Shopping', direction: 'out', amount: 2860, date: '01 Aug 2026', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't16', name: 'Nova Mobile', note: 'Recharge 84 days', category: 'Bills', direction: 'out', amount: 859, date: '01 Aug 2026', method: 'Autopay', status: 'Completed' },
  { id: 't17', name: 'Sana Qureshi', note: 'Book club fund', category: 'Received', direction: 'in', amount: 600, date: '31 Jul 2026', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't18', name: 'FitClub', note: 'Quarterly membership', category: 'Bills', direction: 'out', amount: 4499, date: '30 Jul 2026', method: 'KT Card', status: 'Completed' },
  { id: 't19', name: 'Bean Lane Coffee', note: 'Team catch up', category: 'Food', direction: 'out', amount: 1240, date: '29 Jul 2026', method: 'Scan & pay', status: 'Completed' },
  ...
  { id: 't21', name: 'Dev Malhotra', note: 'Rent share', category: 'Sent', direction: 'out', amount: 12500, date: '28 Jul 2026', method: 'KT Instant Transfer', status: 'Completed' },
  { id: 't22', name: 'Volt Electronics', note: 'USB C hub', category: 'Shopping', direction: 'out', amount: 3299, date: '27 Jul 2026', method: 'KT Card', status: 'Completed' },
  { id: 't23', name: 'RailConnect', note: 'Train booking', category: 'Travel', direction: 'out', amount: 1865, date: '26 Jul 2026', method: 'KT Instant Transfer', status: 'Pending' },
  { id: 't24', name: 'Ishita Roy', note: 'Photography deposit', category: 'Received', direction: 'in', amount: 3500, date: '25 Jul 2026', method: 'KT Instant Transfer', status: 'Completed' },
]
...
export const paymentMethods = [
  { icon: '🔁', name: 'KT Instant Transfer', desc: 'Direct bank transfers with zero fee on peer to peer payments.' },
  { icon: '💳', name: 'KT Card & KT Card Plus', desc: 'Add any domestic or international debit and credit card.' },
  { icon: '🏦', name: 'Net banking', desc: 'Every major bank supported, with instant account verification.' },
  { icon: '⚡', name: 'KT Web3 Vault', desc: 'Non custodial KTC, KTT and KTX held behind a device passkey.' },
  { icon: '📲', name: 'KT Pay', desc: 'Biometric one touch checkout wherever contactless is accepted.' },
  { icon: '🧾', name: 'Autopay mandates', desc: 'Set standing instructions for bills you never want to think about.' },
...
export const initialGoals = [
  { id: 'g1', name: 'Overseas trip', emoji: '✈️', target: 150000, saved: 92400 },
...
export const cryptoHoldings = [
  { symbol: 'KTC', name: 'KT Coin', qty: 0.084, value: 476320, change: 4.25 },
  { symbol: 'KTT', name: 'KT Token', qty: 1.42, value: 427180, change: 2.8 },
  { symbol: 'KTX', name: 'KT Stream', qty: 22.5, value: 348920, change: 8.15 },
  { symbol: 'KTUSD', name: 'KT Dollar', qty: 1850, value: 155310, change: 0.01 },
  { symbol: 'KTY', name: 'KT Layer', qty: 940, value: 56840, change: 1.95 },
]

export const limitsTable = [
  { action: 'KT peer to peer transfer', limit: '₹1,00,000 per day', fee: 'Free', notes: '20 transactions daily' },
  { action: 'Bank account transfer (instant)', limit: '₹5,00,000 per day', fee: 'Free', notes: 'Settles in seconds' },
  ...
  { action: 'Add money to wallet', limit: '₹2,00,000 per day', fee: 'Free', notes: 'KT transfer, netbanking or card' },
]
...
export const walletFeatures = [
  { title: 'Send money in a chat', desc: 'Pay anyone in your contacts without leaving the conversation. Settles in seconds on KT Instant Transfer.' },
  ...
  { title: 'Non custodial crypto vault', desc: 'Hold KTC, KTT and KTX behind a device passkey. Your keys stay in the secure element.' },
...
export const walletFaqs = [
  ...
  },
  {
    ...
    a: 'No. Peer to peer KT transfers and bank transfers are free with no cap on value beyond the daily limits. Fees that do apply international card spend, extra ATM withdrawals are listed in full on this page.',
    tag: 'Fees',
  },
  {
    q: 'Which payment methods are supported?',
    a: 'KT Instant Transfer, KT Card, KT Card Plus, net banking, KT Pay and a non custodial crypto vault. You can hold and spend ten currencies from the travel card.',
    tag: 'Methods',
  },
  {
    q: 'What happens if I send money to the wrong person?',
    a: 'A first time recipient triggers a confirmation step showing the verified name before anything moves. Once an instant transfer settles it cannot be reversed unilaterally, so you would raise a dispute from the receipt.',
    tag: 'Mistakes',
  },
  {
  ...
  },
  {
    ...
    a: 'KT Instant Transfer is capped at ₹1,00,000 across 20 transactions a day, bank transfers at ₹5,00,000 and merchant payments at ₹2,00,000. The full table is in the limits section above.',
    tag: 'Limits',
  },
]

      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden rounded-2xl bg-slate-950 p-4 border border-slate-800">
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div className="flex items-center justify-between border-b border-slate-800 pb-2">
            <div className="flex items-center gap-2">
              <img src={img(avatarFemale)} alt={imgAlt(avatarFemale, "Sarah")} className="h-8 w-8 rounded-full object-cover border border-brand-strong" />
              <div>
          ...
          <div className="flex-1 overflow-y-auto py-2 space-y-2 text-xs">
            ...
            {step >= 2 && (
              ...
              >
                <img src={img(weddingImg)} alt={imgAlt(weddingImg, t('Attachment'))} className="h-28 w-full rounded-xl object-cover" />

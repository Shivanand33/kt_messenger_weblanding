...
import feed1 from '../../assets/images/ai-assistant-app-hero.jpg'
import feed2 from '../../assets/images/group-chat-app-community.jpg'
import feed3 from '../../assets/images/online-marketplace-app-business.jpg'
import feed4 from '../../assets/images/messaging-app-private-chat.jpg'
        ...
        <div className="grid grid-cols-3 gap-1 bg-black p-1">
          {tiles.map((tile) => (
            <div key={tile.name} className="relative aspect-[4/3] overflow-hidden rounded-md">
              <img src={imgSmall(tile.src)} alt={imgAltOnly(tile.src)} loading={mobileLazy} className="h-full w-full object-cover" />

        ...
        <div className="relative aspect-[9/18.5] w-full overflow-hidden rounded-[34px] bg-white flex flex-col">
          ...
          <div className="flex items-center justify-between px-4 py-2">
            ...
            <div className="flex items-center gap-3 text-stone-700 text-base">
              ...
              <img src={img(mumAvatar)} alt={imgAltOnly(mumAvatar)} className="h-6 w-6 rounded-full object-cover" />
            </div>
          </div>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="flex-1 divide-y divide-stone-100 overflow-y-auto">
                {filteredChats.map((chat) => (
                  ...
                  >
                    <img src={img(chat.avatar)} alt={imgAltOnly(chat.avatar)} className="h-10 w-10 rounded-full object-cover shrink-0" />
          ...
          {activeTab === 1 && (
            <div className="flex-1 overflow-y-auto p-3 space-y-2">
              ...
              {chats.map((chat) => (
                ...
                >
                  <img src={img(chat.avatar)} alt={imgAltOnly(chat.avatar)} className="h-9 w-9 rounded-full object-cover shrink-0" />
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">

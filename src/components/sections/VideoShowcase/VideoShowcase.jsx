import { imgAlt } from '../../../utils/imageOverrides'
        ...
        <div className="mt-10 relative">
          ...
          >
              ...
              <div className="lg:col-span-7 relative flex justify-center py-2">
                ...
                >
                  <img src={imgSmall(avatarFemale)} alt={imgAlt(avatarFemale, t('Avatar'))} loading={mobileLazy} className="h-6 w-6 rounded-full object-cover border border-brand-strong" />

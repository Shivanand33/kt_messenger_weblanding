...
mountCrud('/website-content', crudFactory({ model: 'websiteContent', entityName: 'website_content', searchable: ['key', 'label'], parseFilters: (q) => (q.key ? { key: String(q.key) } : {}) }), { resource: 'website_content', createSchema: websiteContentSchema, updateSchema: websiteContentUpdateSchema })
